...
class Ui_MultitableWindow(object):
    def setupUi(self, MultitableWindow):
        ...
        self.CifFileListListWidget.addItem(item)
        item = QtWidgets.QListWidgetItem()
        self.CifFileListListWidget.addItem(item)
        item = QtWidgets.QListWidgetItem()
        self.CifFileListListWidget.addItem(item)
    ...
    def retranslateUi(self, MultitableWindow):
        ...
        __sortingEnabled = self.CifFileListListWidget.isSortingEnabled()
        self.CifFileListListWidget.setSortingEnabled(False)
        item = self.CifFileListListWidget.item(0)
        item.setText(_translate("MultitableWindow", "foo"))
        item = self.CifFileListListWidget.item(1)
        item.setText(_translate("MultitableWindow", "bar"))
        item = self.CifFileListListWidget.item(2)
        item.setText(_translate("MultitableWindow", "baz"))
        self.CifFileListListWidget.setSortingEnabled(__sortingEnabled)
