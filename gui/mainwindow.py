...
class Ui_MultitableWindow(object):
    def setupUi(self, MultitableWindow):
        ...
        sizePolicy.setHeightForWidth(self.CifFileListListWidget.sizePolicy().hasHeightForWidth())
        self.CifFileListListWidget.setSizePolicy(sizePolicy)
        self.CifFileListListWidget.setLocale(QtCore.QLocale(QtCore.QLocale.English, QtCore.QLocale.UnitedStates))
        self.CifFileListListWidget.setDragEnabled(False)
        self.CifFileListListWidget.setDragDropMode(QtWidgets.QAbstractItemView.DragDrop)
        self.CifFileListListWidget.setDefaultDropAction(QtCore.Qt.MoveAction)
