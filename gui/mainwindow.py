...
class Ui_MultitableWindow(object):
    def setupUi(self, MultitableWindow):
        ...
        self.CifFileListTreeWidget = QtWidgets.QTreeWidget(self.groupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        ...
        self.CifFileListTreeWidget.headerItem().setText(0, "1")
        self.CifFileListTreeWidget.header().setVisible(False)
        self.verticalLayout.addWidget(self.CifFileListTreeWidget)
